 ...
 */
function fromRheaMessage(rheaMessage, delivery, shouldReorderLockToken) {
    var _a, _b;
    if (!rheaMessage) {
        rheaMessage = {
            body: undefined
...
class ServiceBusMessageImpl {
    ...
    constructor(msg, delivery, shouldReorderLockToken, receiveMode) {
        const _a = fromRheaMessage(msg, delivery, shouldReorderLockToken), { _rawAmqpMessage } = _a, restOfMessageProps = tslib.__rest(_a, ["_rawAmqpMessage"]);
...
function extractSpanContextFromServiceBusMessage(message) {
    if (!message.applicationProperties || !message.applicationProperties[TRACEPARENT_PROPERTY$1]) {
        return;
    }
    const diagnosticId = message.applicationProperties[TRACEPARENT_PROPERTY$1];
...
class StreamingReceiver extends MessageReceiver {
    ...
    constructor(connectionContext, entityPath, options) {
        ...
        this._onAmqpMessage = async (context) => {
            ...
            (_a = this._lockRenewer) === null || _a === void 0 ? void 0 : _a.start(this, bMessage, (err) => {
            ...
            try {
                ...
                (_b = this._lockRenewer) === null || _b === void 0 ? void 0 : _b.stop(this, bMessage);
                const error = translateServiceBusError(err);
    ...
    async _subscribeImpl(caller) {
        ...
        try {
            ...
            try {
                ...
                receiverLogger.logError(err, `${this.logPrefix} receiver.suspend threw an error`);
            }
            throw err;
        }
    }
...
class ServiceBusReceiverImpl {
    ...
    subscribe(handlers, options) {
        ...
        this._streamingReceiver =
            (_b = this._streamingReceiver) !== null && _b !== void 0 ? _b : new StreamingReceiver(this._context, this.entityPath, Object.assign(Object.assign({}, options), { receiveMode: this.receiveMode, retryOptions: this._retryOptions, lockRenewer: this._lockRenewer }));
...
class ServiceBusMessageBatchImpl {
    ...
    tryAddMessage(originalMessage, options = {}) {
        ...
        let encodedMessage = rheaPromise.message.encode(amqpMessage);
