...
exports.default = {
  ...
  rulesConfigs: _rulesConfigs2.default,
  pages: _pages2.default,
  databases: _databases2.default,
  clientGrants: _clientGrants2.default,
  resourceServers: _resourceServers2.default,
  clients: _clients2.default,
  connections: _connections2.default,
  tenant: _tenant2.default,
  emailProvider: _emailProvider2.default,
  emailTemplates: _emailTemplates2.default,
  guardianFactors: _guardianFactors2.default,
  guardianFactorProviders: _guardianFactorProviders2.default,
  guardianFactorTemplates: _guardianFactorTemplates2.default,
  roles: _roles2.default,
  migrations: _migrations2.default,
  guardianPhoneFactorMessageTypes: _guardianPhoneFactorMessageTypes2.default,
  guardianPhoneFactorSelectedProvider: _guardianPhoneFactorSelectedProvider2.default,
  guardianPolicies: _guardianPolicies2.default,
  actions: _actions2.default,
  organizations: _organizations2.default,
  triggers: _triggers2.default
};