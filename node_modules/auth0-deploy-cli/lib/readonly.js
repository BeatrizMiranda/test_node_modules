...
const readOnly = {
  ...
  tenant: ['sandbox_version', 'sandbox_versions_available', 'flags.allow_changing_enable_sso', 'flags.enable_sso', 'flags.disable_impersonation', 'flags.remove_stale_idp_attributes'],
  clients: ['client_secret', 'callback_url_template', 'signing_keys', 'global', 'tenant', 'custom_login_page_preview', 'config_route', 'owners']
};
...
function deleteKeys(obj, keys) {
  ...
  keys.forEach(k => _dotProp2.default.delete(newObj, k));
  return newObj;
}
...
function cleanAssets(assets, config) {
  ...
  return _lodash2.default.pickBy(cleaned, _lodash2.default.identity);
}