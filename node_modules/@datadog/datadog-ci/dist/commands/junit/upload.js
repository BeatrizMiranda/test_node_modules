...
class UploadJUnitXMLCommand extends clipanion_1.Command {
    constructor() {
        ...
        this.reportMetrics = clipanion_1.Option.Array('--report-metrics');
        this.rawXPathTags = clipanion_1.Option.Array('--xpath-tag');
        this.gitRepositoryURL = clipanion_1.Option.String('--git-repository-url');
        this.skipGitMetadataUpload = clipanion_1.Option.String('--skip-git-metadata-upload', 'true', { validator: t.isBoolean() });
        this.config = {
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const payloads = yield this.getMatchingJUnitXMLFiles(spanTags, customTags, customMetrics, reportTags, reportMetrics);
    ...
    getMatchingJUnitXMLFiles(spanTags, customTags, customMetrics, reportTags, reportMetrics) {
        return __awaiter(this, void 0, void 0, function* () {
            const jUnitXMLFiles = (this.basePaths || [])
                ...
                return acc.concat(glob_1.default.sync((0, utils_1.buildPath)(basePath, '*.xml')));
            }, [])
    ...
    getCustomMetrics() {
        ...
        return Object.assign(Object.assign({}, cliMetrics), envVarMetrics);
    }
    getReportTags() {
        return this.reportTags ? (0, tags_1.parseTags)(this.reportTags) : {};
    }
    getReportMetrics() {
        return this.reportMetrics ? (0, tags_1.parseMetrics)(this.reportMetrics) : {};
    }
