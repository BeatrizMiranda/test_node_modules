...
export declare const getSubscriptionFilters: (client: CloudWatchLogsClient, logGroupName: string) => Promise<import("@aws-sdk/client-cloudwatch-logs").SubscriptionFilter[] | undefined>;
