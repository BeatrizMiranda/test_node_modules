...
class RunTestsCommand extends clipanion_1.Command {
    constructor() {
        ...
        this.pollingTimeout = clipanion_1.Option.String('--pollingTimeout', {
            description: 'The duration (in milliseconds) after which `datadog-ci` stops polling for test results. The default is 30 minutes. At the CI level, test results completed after this duration are considered failed.',
        ...
        this.variableStrings = clipanion_1.Option.Array('-v,--variable', { description: 'Pass a variable override.' });
    ...
    resolveConfig() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.config = (0, deep_extend_1.default)(this.config, (0, utils_1.removeUndefinedValues)({
                ...
                locations: (_a = process.env.DATADOG_SYNTHETICS_LOCATIONS) === null || _a === void 0 ? void 0 : _a.split(';'),
            ...
            this.config.global = (0, deep_extend_1.default)(this.config.global, (0, utils_1.removeUndefinedValues)({
                mobileApplicationVersionFilePath: this.mobileApplicationVersionFilePath,
                variables: (0, public_1.parseVariablesFromCli)(this.variableStrings, (log) => { var _a; return (_a = this.reporter) === null || _a === void 0 ? void 0 : _a.log(log); }),
                pollingTimeout: (_c = (_b = this.pollingTimeout) !== null && _b !== void 0 ? _b : this.config.global.pollingTimeout) !== null && _c !== void 0 ? _c : this.config.pollingTimeout,
            }));
