...
import { APIHelperConfig, BrowserServerResult, ExecutionRule, MainReporter, Operator, Reporter, Result, ResultDisplayInfo, ResultSkippedBySelectiveRerun, RunTestsCommandConfig, ServerResult, Suite, Summary, SyntheticsCIConfig, SyntheticsOrgSettings, Test, TestPayload, Trigger, TriggerConfig, UserConfigOverride } from '../interfaces';
...
export declare const hasResultPassed: (serverResult: ServerResult, hasTimedOut: boolean, failOnCriticalErrors: boolean, failOnTimeout: boolean) => boolean;
...
export declare const runTests: (api: APIHelper, testsToTrigger: TestPayload[], selectiveRerun?: boolean) => Promise<Trigger>;
...
export declare const getResultUrl: (baseUrl: string, test: Test, resultId: string) => string;
/**
