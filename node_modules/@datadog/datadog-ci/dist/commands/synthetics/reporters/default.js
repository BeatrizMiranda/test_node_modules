...
exports.getTunnelReporter = exports.DefaultReporter = void 0;
...
const renderExecutionResult = (test, execution, baseUrl) => {
    ...
    if ((0, internal_1.hasResult)(execution) && !execution.result.unhealthy) {
        const duration = (0, public_1.getResultDuration)(execution.result);
    ...
    if ((0, public_1.isResultSkippedBySelectiveRerun)(execution)) {
        const resultUrl = (0, public_1.getResultUrl)(baseUrl, test, resultId);
        const resultInfo = `  ${setColor('◂')} Successful result from previous CI run: ${chalk_1.default.dim.cyan(resultUrl)}`;
        outputLines.push(resultInfo);
    }
    else {
...
const getResultIdentificationSuffix = (execution, setColor) => {
    if ((0, internal_1.hasResult)(execution)) {
...
class DefaultReporter {
    ...
    testsWait(tests, baseUrl, batchId, skippedCount) {
        ...
        const text = `Waiting for ${chalk_1.default.bold.cyan(tests.length)} ${testCountText}${skippingCountText} ${testsDisplay}…\n`;
