...
exports.getCIEnv = exports.getCIMetadata = exports.getCISpanTags = exports.PROVIDER_TO_DISPLAY_NAME = exports.CI_ENGINES = void 0;
...
const getCISpanTags = () => {
    ...
    if (env.GITHUB_ACTIONS || env.GITHUB_ACTION) {
        const { GITHUB_RUN_ID, GITHUB_WORKFLOW, GITHUB_RUN_NUMBER, GITHUB_WORKSPACE, GITHUB_HEAD_REF, GITHUB_JOB, GITHUB_REF, GITHUB_SHA, GITHUB_REPOSITORY, GITHUB_SERVER_URL, GITHUB_RUN_ATTEMPT, } = env;
    ...
    if (env.JENKINS_URL) {
        const { WORKSPACE, BUILD_TAG, JOB_NAME, BUILD_NUMBER, BUILD_URL, GIT_BRANCH: JENKINS_GIT_BRANCH, GIT_COMMIT, GIT_URL, GIT_URL_1, DD_CUSTOM_TRACE_ID, NODE_NAME, NODE_LABELS, } = env;
        tags = {
            [tags_1.CI_ENV_VARS]: JSON.stringify({ DD_CUSTOM_TRACE_ID }),
...
const getCIEnv = () => {
    ...
    throw new Error('Only providers [GitHub, GitLab, CircleCI, Buildkite, Buddy, Jenkins, TeamCity, AzurePipelines] are supported');
};
