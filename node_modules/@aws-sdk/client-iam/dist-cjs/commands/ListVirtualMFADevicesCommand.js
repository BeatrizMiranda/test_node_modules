...
class ListVirtualMFADevicesCommand extends smithy_client_1.Command
    ...
    .f(void 0, models_0_1.ListVirtualMFADevicesResponseFilterSensitiveLog)
    .ser(Aws_query_1.se_ListVirtualMFADevicesCommand)
    .de(Aws_query_1.de_ListVirtualMFADevicesCommand)
    .build() {
}
